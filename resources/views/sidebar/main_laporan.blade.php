    ...
    <aside style="background-color:#68b1f0;" id="left-panel" class="left-panel ">
        <nav style="background-color:#68b1f0;" class="navbar navbar-expand-sm navbar-default ">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><img src="{{ asset('style/images/1.1.png') }}" alt="Brand icon" style="width: 80px; height:80px;" class="p-3 ">Daftung</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse mt-3">
                <ul class="nav navbar-nav  nav-underline flex-column  hidden">
                    <li class="menu-item-has-children">
                        <a class="nav-link  fw-bold me-3"  href="{{ url('home') }}"> <i class="menu-icon fa fa-home "></i><b>Home</b></a>
                    </li>
                    <li class=" menu-item-has-children">
                        <a class="nav-link fw-bold  me-3" href="{{ url('Transaksi') }}"> <i class="menu-icon fa fa-file-text-o"></i><b>Transaksi </b></a>
                    </li>
                    <li class="menu-item-has-children">
                        <a class="nav-link fw-bold active  me-3" href="{{ url('laporan') }}"><i class="menu-icon fa fa-file"></i><b>Laporan Transaksi </b></a>
                    </li>                                    
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
