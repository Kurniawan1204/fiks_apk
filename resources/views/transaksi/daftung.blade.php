    ...
    <div class="animated fadeIn">
        ...
        <div class="card hv-100"> 
            ...
            <tbody>
                @foreach ($transaksi as $item)
                    <tr align="center">
                        ...
                        <td>{{ $item-> Status}}</td>
                        <td>
                            <!-- Tooltip untuk ikon mata (fa-eye) -->
                            ...
                            <!-- Tooltip untuk ikon pensil (fa-pencil) -->
                            <a href="{{ url('transaksi/edit/' . $item->id) }}" class="btn btn-outline-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit Transaksi">
                        ...
                        {{-- <td class="mx-auto">
                            ...
                            {{-- <form action="{{ url('Transaksi/' . $item->id) }}" method="POST" 
                                class="d-inline" onsubmit="return confirm('Yakin untuk menghapusnya?') ">
                                @method('delete')
                                @csrf
            ...
            <div class="d-flex h-25 w-50">
                {{ $transaksi->links('pagination::bootstrap-4') }}            </div>            
         </div>
        </div>
